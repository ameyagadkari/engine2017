/*
    ...
    It is important to differentiate a "constant buffer" from the actual constant data:
...
namespace eae6320
{
    namespace Graphics
    {
        ...
        //        * Each material owns its own constant buffer
        //            which is initialized when a material is created
        //            and updated in rare cases when a material value changes at run-time
        //            but otherwise only needs to be bound before rendering.
        //    * Per-Draw Call:
...
namespace eae6320
{
    namespace Graphics
    {
        ...
        private:
            ...
            cConstantBuffer( cConstantBuffer&& i_instanceToBeMoved ) = delete;
            cConstantBuffer& operator =( cConstantBuffer&& i_instanceToBeMoved ) = delete;
        };
    }
}
