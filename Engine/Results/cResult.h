...
namespace eae6320
{
    namespace Results
    {
        ...
        static_assert( static_cast<uint8_t>( System::Count ) <= 0x80, "A result's system ID must fit into 7 bits" );
    }
}
...
#define EAE6320_RESULTS_SYSTEM_SHIFT 24
        ...
        constexpr Results::System GetSystem() const
        {
            return static_cast<Results::System>( ( value & EAE6320_RESULTS_SYSTEM_MASK ) >> EAE6320_RESULTS_SYSTEM_SHIFT );
        }
...
#define EAE6320_RESULTS_SEVERITY_SHIFT 16
        ...
        // Defines a result
        constexpr cResult( const Results::eResult i_isSuccess, const Results::System i_system, const uint16_t i_id,
        ...
        constexpr cResult()
            :
            cResult( Results::IsFailure, Results::System::General, Results::Severity::Default, ~static_cast<uint16_t>( 0x0 ) )
        {
