...
namespace
{
    ...
    eae6320::cResult LoadUserSettingsIntoLuaTable(lua_State& io_luaState)
    {
        ...
        if (eae6320::Platform::DoesFileExist(s_userSettingsFileName))
        {
            ...
            if (luaResult == LUA_OK)
            {
                ...
                {
                    constexpr auto noArguments = 0;
                    constexpr auto noReturnValues = 0;
                    constexpr auto noErrorMessageHandler = 0;
    ...
    eae6320::cResult PopulateUserSettingsFromLuaTable(lua_State& io_luaState)
    {
        ...
        // Resolution Width
        {
            const auto key_width = "resolutionWidth";
        ...
        // Resolution Height
        {
            const auto key_height = "resolutionHeight";
